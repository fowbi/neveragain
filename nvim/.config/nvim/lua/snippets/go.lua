...
local su = require("snippets.common.snips_utils")
local cp = su.copy
...
ls.add_snippets("go", {
  ...
  s({ trig = "var", descr = '(var) "Variable declaration"', priority = -50, trigEngine = te("b") }, {
    ...
    tr(2, "(.+)", " "),
    i(2, "type", { key = "i2" }),
    c(3, { { t(" = "), i(1, "value", { key = "i0" }) }, { i(1, jt({ " = ", "value" })) } }, { key = "i3" }),
  }),
  s({ trig = "vars", descr = '(vars) "Variables declaration"', priority = -50, trigEngine = te("b") }, {
    ...
    c(
      3,
      { { t(" = "), i(1, "value", { key = "i0" }), t(" ") }, { i(1, jt({ " = ", "value", " " })) } },
      { key = "i3" }
    ),
    nl(),
    t(")"),
  ...
  s({ trig = "cs", descr = '(cs) "case"', priority = -1000, trigEngine = te("w") }, {
    ...
    d(2, function(args, snip)
      return sn(nil, { i(1, jt({ snip.env.LS_SELECT_DEDENT or {} }, "\t"), { key = "i0" }) })
    end),
  }),
  ...
  s(
    { trig = "^import", descr = '(^import) "Import declaration"', priority = -50, trigEngine = te("r"), regTrig = true },
    {
      t("import ("),
      nl(),
      t('\t"'),
  ...
  s({
    trig = "^package",
    descr = '(^package) "Package declaration"',
    priority = -50,
    trigEngine = te("r"),
    regTrig = true,
  }, {
  ...
  s(
    { trig = "^cons", descr = '(^cons) "Constants declaration"', priority = -50, trigEngine = te("r"), regTrig = true },
    {
      t("const ("),
      nl(),
      t("\t"),
